---
titulo: "Directiva de inundaciones. Directiva 2007/60/CE del PE y del Consejo de 23 de octubre de 2"
titulo_html: null
ruta_antigua: "/servicios/legislacion/europa/directiva_inundaciones.php"
url_antigua: "https://www.aguasgrancanaria.com/servicios/legislacion/europa/directiva_inundaciones.php"
...
encabezados: 
  - nivel: 4
    texto: "Contenido:"
  - nivel: 5
    texto: "DIRECTIVA 2007/60/CE DEL PARLAMENTO EUROPEO Y DEL CONSEJO de 23 de octubre de 2007 relativa a:"
  - nivel: 6
    texto: "Evaluación y Gestión de los Riesgos de Inundación"
  - nivel: 5
    texto: "EL PARLAMENTO EUROPEO Y EL CONSEJO DE LA UNIÓN EUROPEA"
documentos: 
  - titulo: null
    url_antigua: "https://www.aguasgrancanaria.com/servicios/legislacion/europa/Dir_Inundaciones.pdf"
    ruta_nueva: "/documentos/servicios/legislacion/europa/dir_inundaciones.pdf"
    tipo: "pdf"
    bytes: 80872
imagenes: 
  - url_antigua: "https://www.aguasgrancanaria.com/img/logociagc_cian_peq_agua_clara.gif"
    ...
    alt: null
    enlazada: false
  - url_antigua: "https://www.aguasgrancanaria.com/img/dir_inundaciones.gif"
    ruta_nueva: "/imagenes/img/dir_inundaciones.gif"
    alt: "Dir_Inundaciones.pdf"
    enlazada: false
videos: []
iframes: []
enlaces_externos: []
...
telefonos: []
tablas: 
  - archivo: "tablas/servicios/legislacion/europa/directiva_inundaciones/tabla-01.json"
    titulo: null
    filas: 4
    columnas: 5
referencias_rotas: []
...
<!-- tabla 01: tablas/servicios/legislacion/europa/directiva_inundaciones/tabla-01.json -->

|  |  |  |  |  |
| --- | --- | --- | --- | --- |
| Legislación Creada el 19/05/2010 | Título | Directiva de inundaciones |  |  |
|  | Descripción | Directiva 2007/60/CE del PE y del Consejo de 23 de octubre de 2007 relativa a la evaluación y gestión de los riesgos de inundación |  |  |
|  | Código | Aprobado | Categoría | Ámbito |
|  | Agua Inund |  | Directiva | Union Europea |
...
1.  Las inundaciones pueden provocar víctimas mortales, el desplazamiento de personas, causar daños al medio ambiente, comprometer gravemente el desarrollo económico y debilitar las actividades económicas de la Comunidad.
...
8.  En virtud del Reglamento (CE) no 2012/2002 del Consejo, de 11 de noviembre de 2002, por el que se crea el Fondo de Solidaridad de la Unión Europea (1), puede concederse ayuda económica rápida en caso de catástrofe grave para ayudar a las personas, zonas naturales, regiones y países afectados a recuperar unas condiciones lo más normales posible. Sin embargo, dicho Fondo solo puede intervenir para operaciones de emergencia y no para las fases que preceden a una emergencia.
9.  En la elaboración de políticas sobre usos de las aguas y el suelo, los Estados miembros y la Comunidad deben considerar los impactos potenciales de estas políticas en los riesgos de inundación y la gestión de los riesgos de inundación.
...
13.  Para evitar y reducir los impactos adversos de las inundaciones en la zona afectada conviene estipular el establecimiento de planes de gestión del riesgo de inundación. Las causas y consecuencias de las inundaciones varían según los países y regiones de la Comunidad.
...
[![Dir_Inundaciones.pdf](/imagenes/img/dir_inundaciones.gif)](/documentos/servicios/legislacion/europa/dir_inundaciones.pdf)
