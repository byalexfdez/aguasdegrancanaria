---
titulo: Recursos Superficiales
url: /divulgacion/plan-hidrologico-1988/recursos-superficiales/
nodo: p88-recursos-superficiales
seccion: divulgacion
plantilla: hub
antetitulo: DIVULGACIÓN
ruta_antigua: /divulgacion/recursos_superficiales.php
contenido_oculto_en_origen: 0
descripcion: El conocimiento de los recursos hidráulicos superficiales tiene interés según una doble vertiente. Por una parte, por la necesidad de cuantificación y…
---
...
A pesar de que aprovechar las aguas que discurren en superficie por los barrancos parece elprocedimiento más a la mano y el más obvio para aumentar nuestras disponibilidades hidráulicas, no siempre es el más fácil, ni por supuesto el más barato.

## RECURSOS TOTALES

La única estimación de la aportación superficial realizada hasta la fecha tuvo lugar durante el SPA-15. Utilizando los datos conocidos de pluviometría y estimando la evapotranspiración en la isla se dedujo una aportación superficial comprendida entre 64 y 85 hm3 según diferentes referencias. Ya en el mismo estudio, se expresan las cautelas sobre la validez de estos datos.
...
En el documento citado, se relacionan los caudales y los volúmenes autorizados con el valor de la precipitación media (Figura 3), poniéndose de manifiesto que no ha existido criterio de regulación de la aportación superficial a la hora de otorgar dichas concesiones, por lo que se habrán de adoptar medidas de Ordenanzaque actualicen las concesiones.

 [![](/imagenes/img/3_t_presas_peq.gif) Tabla 1.- Grandes presas](/divulgacion/plan-hidrologico-1988/recursos-superficiales/tabla-1-grandes-presas/)

 [![](/imagenes/img/3_t_obras_almac_peq.gif) Tabla 2.- Obras de almacenamiento en Gran Canaria](/divulgacion/plan-hidrologico-1988/recursos-superficiales/tabla-2-obras-de-almacenamiento/)
...
Por otra parte, para conseguir una mejor explotación de los recursos superficiales, se hace necesaria la necesidad de fomentar el dichos recursos dentro de una misma cuenca y un mismo recinto de los agrupamiento de los particulares que capten definidos en la zonificación de la isla.
...
Del estudio de los volúmenes embalsados en grandes presas, realizado por el Servicio Hidráulico de Las Palmas , se deduce la cifra de un 12% de la capacidad de embalse como el volumen medio interanual aprovechado.
 ...
 [![](/imagenes/img/3_d_aprovecham_peq.jpg) Figura 1.- Aprovechamientos por cuencas](/imagenes/img/3_d_aprovechamientos.gif)

 [![](/imagenes/img/3_d_presas_peq.gif) Figura 2.- Capacidad de las presas](/imagenes/img/3_d_presas.gif)
...
[![](/imagenes/img/3_t_max_avdas_peq.gif) Tabla 3.- Máximas avenidas por cuencas](/imagenes/img/3_t_max_avdas.gif)

[![](/imagenes/img/3_d_almac_precip_peq.gif) Figura 3.- Comparación almacenamiento-precipitación](/imagenes/img/3_d_almac_precip.gif)
