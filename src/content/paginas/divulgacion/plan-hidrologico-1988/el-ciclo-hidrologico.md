---
titulo: El Ciclo hidrológico
url: /divulgacion/plan-hidrologico-1988/el-ciclo-hidrologico/
nodo: p88-el-ciclo-hidrologico
seccion: divulgacion
plantilla: pagina
antetitulo: DIVULGACIÓN
ruta_antigua: /divulgacion/ciclo_hidrologico.php
contenido_oculto_en_origen: 0
descripcion: El concepto del ciclo del agua asume el hecho de que la cantidad o masa total de agua en la hidrosfera permanece constante en el tiempo. Se trata de un…
---
...
El ciclo hidrológico constituyte un fenómeno sin el cual sería imposible la vida en el planeta. a lo largo de la historia la humanidad se ha beneficiado de él aprovechando las aguas de las lluvias y captando el agua en las fases de circulación superficial o subterránea. Estos son pues, los aspectos del ciclo que en el orden práctico adquieren mayor importancia: las precipitaciones y la circulaciíon de aguas superficiales y subterráneas.
...
Principalmente son dos las situaciones atmosféricas que producen precipitaciones en el Archipiélago: la primera, ocasionada por las invasiones de aire polar frío por el norte y la segunda por la intrusión de aire húmedo y cálido desde el sur.
...
![](/imagenes/img/d_precip_periodo.gif)

Figura 1 .- Variación de la precipitación en el periodo 1951-1994, (Plan Hidrológico de G.C., 1995)

![](/imagenes/img/d_precip_mensual.gif)
...
![](/imagenes/img/d_evapo_precip.gif)
