---
titulo: Funciones
url: /el-consejo/funciones/
nodo: funciones
seccion: el-consejo
plantilla: pagina
antetitulo: EL CONSEJO INSULAR
ruta_antigua: /el_consejo/funciones.php
ultima_actualizacion: 2025-03-09
contenido_oculto_en_origen: 0
descripcion: Como resultado de sus funciones, El Consejo Insular de Aguas de Gran Canaria desarrolla un amplio conjunto de actividades con el objeto de realizar la…
---

## FUNCIONES

### Las funciones del Consejo Insular de Aguas de Gran Canaria son:
...
Como resultado de sus funciones, El Consejo Insular de Aguas de Gran Canaria desarrolla un amplio conjunto de actividades con el objeto de realizar la dirección, ordenación, planificación y gestión de las aguas insulares.

Dichas actividades se pueden agrupar en tres grandes grupos:

\- Gestión de los Recursos Hidráulicos de la isla de Gran Canaria.

\- Desarrollo de Infraestructuras Hidráulicas para garantizar el adecuado uso del agua.

\- Planificación Hidrológica e Investigación.

Descargar Documentos[TXT](/documentos/el_consejo/funciones.txt)
